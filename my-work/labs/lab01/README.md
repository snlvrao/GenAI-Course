...
- Add a second provider you can reach for free to your .env. The quickest is a free hosted key, which downloads nothing: the setup page shows how to get one from Groq or Google. Any second local model you already have works too. Buy nothing.
